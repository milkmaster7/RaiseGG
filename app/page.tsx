...
const GAMES = [
  ...
  { name: 'Dota 2',  href: '/games/dota2',     description: 'Auto-verified results via Steam API.',               art: 'https://cdn.cloudflare.steamstatic.com/apps/dota2/images/dota2_social.jpg' },
